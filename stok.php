  ...
  <main id="main" class="main">
    ...
    <section class="section">
      <div class="row">
        ...
        <i class="fas fa-plus"></i> Tambah Stock Barang
      </button>
                  ...
                  <tbody>
                    ...
                    if ($result->num_rows > 0) {
                      while($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>
                                <button type='button' class='btn btn-primary editBtn' data-bs-toggle='modal' data-bs-target='#editModal' data-id='".$row["id_stock"]."' data-nama='".$row["nama"]."' data-jenis='".$row["jenis"]."' data-stock='".$row["stock"]."' data-harga='".$row["harga"]."'>Edit</button>
                                <button type='button' class='btn btn-danger deleteBtn' data-id='".$row["id_stock"]."'>Delete</button>
                              </td>";
                        echo "</tr>";
                      }
                    } else {

...
$sql = "SELECT bk.id_brklr, bk.tgl, bk.jumlah, s.nama FROM brg_keluar bk JOIN stock s ON bk.id_stock = s.id_stock";
          ...
          <div class="card">
            <div class="card-body">
              <div class="table-responsive">
                <br>
                <button type="button" class="btn btn-success mb-3" onclick="window.location.href='generate_brkeluar.php'">
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="tambahModalLabel">Tambah Barang Keluar</h5>
